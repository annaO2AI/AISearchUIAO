            ...
            <form onSubmit={analyzeFormik.handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  type="file"
                  multiple
                  // Remove value prop completely for file inputs
                  ...
                  key={analyzeFormik.values.existing_files.length} // Add key to force re-render
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full text-sm text-gray-500
                    ...
                    hover:file:bg-blue-100"
                  accept={SUPPORTED_FILE_EXTENSIONS}
                  key={analyzeFormik.values.new_file?.name || "empty"} // Add key to force re-render
                />
